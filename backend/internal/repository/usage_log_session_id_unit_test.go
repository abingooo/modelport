...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 60, "arg-type table must include the billing and upstream response model union")
	...
	// ModelPort appends created_at and billing_model after the upstream session_id field.
	sessionIDArgIndex := len(usageLogInsertArgTypes) - 3
