...
const instructionAuditV13EventIndexesMigration = "207_instruction_audit_v13_event_indexes_notx.sql"

var instructionAuditV13EventIndexes = []string{
...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// These checksums use the runner's SHA-256(strings.TrimSpace(content)) convention.
	// The upstream v0.1.173 constants hashed the raw blobs and could never match.
...
func prepareNonTransactionalMigration(ctx context.Context, db migrationConnection, name string) error {
	...
	case instructionAuditV13EventIndexesMigration:
