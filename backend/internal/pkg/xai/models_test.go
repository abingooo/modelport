...
func TestDefaultModelMappingExcludesCrossClientWildcards(t *testing.T) {
	...
	require.Equal(t, DefaultTTSModel, mapping[DefaultTTSModel])
	require.Equal(t, DefaultSTTModel, mapping[DefaultSTTModel])
	require.Equal(t, GrokVoiceThinkFast1Model, mapping[GrokVoiceThinkFast1Model])
	require.Equal(t, GrokVoiceThinkFast2Model, mapping[GrokVoiceThinkFast2Model])
	require.Equal(t, DefaultRealtimeModel, mapping[DefaultRealtimeModel])
