...
const (
	...
	DefaultTTSModel                  = "grok-tts"
	DefaultSTTModel                  = "grok-stt"
	DefaultRealtimeModel             = "grok-voice-latest"
	GrokVoiceThinkFast1Model         = "grok-voice-think-fast-1.0"
	GrokVoiceThinkFast2Model         = "grok-voice-think-fast-2.0"
)
...
func ModelMappingWithOptions(opts ModelMappingOptions) map[string]string {
	...
	// Voice HTTP endpoints do not carry a model field, but scheduling still uses
	// these identities as the account model_mapping whitelist. Keep the Realtime
	// latest alias unchanged on the wire; account-specific mappings may override it.
	mapping[DefaultTTSModel] = DefaultTTSModel
	mapping[DefaultSTTModel] = DefaultSTTModel
	mapping[GrokVoiceThinkFast1Model] = GrokVoiceThinkFast1Model
	mapping[GrokVoiceThinkFast2Model] = GrokVoiceThinkFast2Model
	mapping[DefaultRealtimeModel] = DefaultRealtimeModel
