...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"POST /api/v1/admin/instruction-audit/scopes":                {},
	"PUT /api/v1/admin/instruction-audit/scopes/:id":             {},
	"DELETE /api/v1/admin/instruction-audit/scopes/:id":          {},
	"POST /api/v1/admin/instruction-audit/client-profiles":       {},
	"PUT /api/v1/admin/instruction-audit/client-profiles/:id":    {},
	"DELETE /api/v1/admin/instruction-audit/client-profiles/:id": {},
	"POST /api/v1/admin/instruction-audit/user-allowlist":        {},
	"DELETE /api/v1/admin/instruction-audit/user-allowlist/:id":  {},
	"POST /api/v1/admin/instruction-audit/ai-nodes":              {},
	"PUT /api/v1/admin/instruction-audit/ai-nodes/:id":           {},
	"DELETE /api/v1/admin/instruction-audit/ai-nodes/:id":        {},
	"POST /api/v1/admin/instruction-audit/ai-nodes/:id/test":     {},
	"DELETE /api/v1/admin/instruction-audit/events/:id":          {},
	"POST /api/v1/admin/instruction-audit/events/batch-delete":   {},
	"POST /api/v1/admin/instruction-audit/events/:id/trust":      {},
}
