...
var auditSensitiveReads = map[string]string{
	...
	"GET /api/v1/admin/instruction-audit/translations/:id":        "admin.instruction_audit.translation.read",
	"GET /api/v1/admin/instruction-audit/sensitive-access/me":     "admin.instruction_audit.sensitive_access.me",
	"GET /api/v1/admin/instruction-audit/sensitive-access/grants": "admin.instruction_audit.sensitive_access.list",
}
...
var auditActionOverrides = map[string]string{
	...
	"PUT /api/v1/admin/instruction-audit/hashes/:id/scopes/:rule_set_id":           "admin.instruction_audit.hash_scope.update",
	...
	"POST /api/v1/admin/instruction-audit/hashes/:id/raw-access":                   "admin.instruction_audit.hash_raw.copy",
	"POST /api/v1/admin/instruction-audit/events/:id/evidence-access":              "admin.instruction_audit.event_evidence.copy",
	"POST /api/v1/admin/instruction-audit/translations":                            "admin.instruction_audit.translation.create",
	"PUT /api/v1/admin/instruction-audit/sensitive-access/grants/:user_id":         "admin.instruction_audit.sensitive_access.grant",
	"POST /api/v1/admin/instruction-audit/sensitive-access/grants/:user_id/revoke": "admin.instruction_audit.sensitive_access.revoke",
}
...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"PUT /api/v1/admin/instruction-audit/enabled":                        {},
	"PUT /api/v1/admin/instruction-audit/config":                         {},
	"PUT /api/v1/admin/instruction-audit/reason-policies/:reason":        {},
	"POST /api/v1/admin/instruction-audit/hashes":                        {},
	"PUT /api/v1/admin/instruction-audit/hashes/:id":                     {},
	"PUT /api/v1/admin/instruction-audit/hashes/:id/scopes/:rule_set_id": {},
	"DELETE /api/v1/admin/instruction-audit/hashes/:id":                  {},
	"POST /api/v1/admin/instruction-audit/rule-sets":                     {},
	"PUT /api/v1/admin/instruction-audit/rule-sets/:id":                  {},
	"DELETE /api/v1/admin/instruction-audit/rule-sets/:id":               {},
	"POST /api/v1/admin/instruction-audit/group-bindings":                {},
	"DELETE /api/v1/admin/instruction-audit/group-bindings/:id":          {},
	"POST /api/v1/admin/instruction-audit/events/:id/candidates":         {},
	"DELETE /api/v1/admin/instruction-audit/events/:id":                  {},
	"POST /api/v1/admin/instruction-audit/events/batch-delete":           {},
	"POST /api/v1/admin/instruction-audit/events/delete-preview":         {},
	"POST /api/v1/admin/instruction-audit/events/delete-by-filter":       {},
	"POST /api/v1/admin/instruction-audit/events/:id/rule-set":           {},
}
