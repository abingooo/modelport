...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"POST /api/v1/admin/instruction-audit/scopes/batch":               {},
	"DELETE /api/v1/admin/instruction-audit/scopes/group/:id":         {},
	...
	"POST /api/v1/admin/instruction-audit/risk-hashes":                {},
	"PUT /api/v1/admin/instruction-audit/risk-hashes/:id":             {},
	"DELETE /api/v1/admin/instruction-audit/risk-hashes/:id":          {},
	"POST /api/v1/admin/instruction-audit/risk-hashes/:id/raw-access": {},
	"POST /api/v1/admin/instruction-audit/review-jobs/:id/retry":      {},
