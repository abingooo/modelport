		...
		servermiddleware.APIKeyAuthMiddleware(func(c *gin.Context) {
			...
			c.Set(string(servermiddleware.ContextKeyAPIKey), &service.APIKey{
				...
				Group: &service.Group{
					...
					VideoPrice480P:               &explicitFreePrice,
					VideoPrice720P:               &explicitFreePrice,
					VideoPrice1080P:              &explicitFreePrice,
					SearchPricePer1k:             &explicitFreePrice,
					AudioRealtimePricePerMin:     &explicitFreePrice,
					AudioTTSPricePerMillionChars: &explicitFreePrice,
					AudioSTTPricePerHour:         &explicitFreePrice,
				},
			})
			c.Next()
		}),
