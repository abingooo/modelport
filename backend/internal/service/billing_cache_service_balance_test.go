...
func TestCheckBillingEligibility_FreeGroupAllowsZeroBalance(t *testing.T) {
	...
	err := svc.CheckBillingEligibility(context.Background(), &User{ID: 1}, nil, &Group{IsFree: true}, nil, "anthropic")
	require.NoError(t, err)
}
