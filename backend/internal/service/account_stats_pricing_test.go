...
func TestCalculateStatsCost_NilPricing(t *testing.T) {
	result := calculateStatsCost(nil, accountStatsUsage{RequestCount: 1})
	require.Nil(t, result)
}
...
func TestCalculateStatsCost_TokenBilling(t *testing.T) {
	...
	result := calculateStatsCost(pricing, accountStatsUsage{Tokens: tokens, RequestCount: 1})
	require.NotNil(t, result)
...
func TestCalculateStatsCost_PerRequestBilling(t *testing.T) {
	...
	result := calculateStatsCost(pricing, accountStatsUsage{Tokens: tokens, RequestCount: 3})
	require.NotNil(t, result)
	// 0.05 * 3 = 0.15
...
func TestCalculateStatsCost_PerRequestBilling_PriceNil(t *testing.T) {
	...
	result := calculateStatsCost(pricing, accountStatsUsage{RequestCount: 1})
	require.Nil(t, result)
}
...
func TestCalculateStatsCost_ImageBilling(t *testing.T) {
	...
	result := calculateStatsCost(pricing, accountStatsUsage{RequestCount: 2})
	require.NotNil(t, result)
	// 0.10 * 2 = 0.20
...
func TestCalculateStatsCost_ImageBilling_PriceZero(t *testing.T) {
	pricing := &ChannelModelPricing{
		BillingMode:     BillingModeImage,
		PerRequestPrice: testPtrFloat64(0),
	}
...
func TestCalculateStatsCost_VideoBilling_ResolutionTierOverridesFlatPrice(t *testing.T) {
	pricing := &ChannelModelPricing{
		BillingMode:     BillingModeVideo,
		PerRequestPrice: testPtrFloat64(0.10),
		Intervals: []PricingInterval{
			{TierLabel: VideoBillingResolution720P, PerRequestPrice: testPtrFloat64(0.25)},
		},
	}
	result := calculateStatsCost(pricing, accountStatsUsage{
		VideoCount:           2,
		VideoResolution:      "hd",
...
func TestCalculateStatsCost_VideoBilling_UnmatchedTierFallsBackToFlatPrice(t *testing.T) {
	pricing := &ChannelModelPricing{
		BillingMode:     BillingModeVideo,
		PerRequestPrice: testPtrFloat64(0.10),
		Intervals: []PricingInterval{
	...
	require.NotNil(t, result)
	require.InDelta(t, 0.30, *result, 1e-12)
}

func TestCalculateStatsCost_VideoBilling_MissingDurationDefaultsToEightSeconds(t *testing.T) {
	pricing := &ChannelModelPricing{
		BillingMode:     BillingModeVideo,
		PerRequestPrice: testPtrFloat64(0.10),
	}
	result := calculateStatsCost(pricing, accountStatsUsage{VideoCount: 1})
	require.NotNil(t, result)
	require.InDelta(t, 0.80, *result, 1e-12)
}

func TestCalculateStatsCost_VideoBilling_MultipliesVideoCount(t *testing.T) {
	pricing := &ChannelModelPricing{
		BillingMode:     BillingModeVideo,
		PerRequestPrice: testPtrFloat64(0.10),
	}
	...
	require.NotNil(t, result)
	require.InDelta(t, 1.50, *result, 1e-12)
}

func TestCalculateStatsCost_VideoBilling_NoCompletedVideoReturnsNil(t *testing.T) {
	pricing := &ChannelModelPricing{
		BillingMode:     BillingModeVideo,
		PerRequestPrice: testPtrFloat64(0.10),
	}
	require.Nil(t, calculateStatsCost(pricing, accountStatsUsage{VideoCount: 0}))
	require.Nil(t, calculateStatsCost(pricing, accountStatsUsage{VideoCount: -1}))
}

func TestCalculateStatsCost_VideoBilling_TierExplicitZeroOverridesFlatPrice(t *testing.T) {
	pricing := &ChannelModelPricing{
		BillingMode:     BillingModeVideo,
		PerRequestPrice: testPtrFloat64(0.10),
		Intervals: []PricingInterval{
			{TierLabel: VideoBillingResolution720P, PerRequestPrice: testPtrFloat64(0)},
		},
	}
	result := calculateStatsCost(pricing, accountStatsUsage{
		VideoCount:           1,
...
func TestCalculateStatsCost_VideoBilling_FlatExplicitZeroReturnsZero(t *testing.T) {
	pricing := &ChannelModelPricing{
		BillingMode:     BillingModeVideo,
		PerRequestPrice: testPtrFloat64(0),
	}
...
func TestTryCustomRules_FirstMatchWins(t *testing.T) {
	...
	result := tryCustomRules(channel, 999, 1, "", "claude-opus-4", accountStatsUsage{Tokens: tokens, RequestCount: 1})
	require.NotNil(t, result)
...
func TestTryCustomRules_NoMatch_ReturnsNil(t *testing.T) {
	...
	tokens := UsageTokens{InputTokens: 100}
	result := tryCustomRules(channel, 999, 2, "", "claude-opus-4", accountStatsUsage{Tokens: tokens, RequestCount: 1})
...
func TestResolveAccountStatsCost_NilChannelService(t *testing.T) {
	result := resolveAccountStatsCost(
		...
		1, 1, "claude-sonnet-4",
		accountStatsUsage{Tokens: UsageTokens{InputTokens: 100}, RequestCount: 1}, 0.5, "",
	)
	require.Nil(t, result)
}
...
func TestResolveAccountStatsCost_HitsCustomRule(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		accountStatsUsage{Tokens: tokens, RequestCount: 1}, 999.0, "priority", // 自定义账号价格不叠加服务层级倍率
	)
	require.NotNil(t, result)
...
func TestResolveAccountStatsCost_ApplyPricingToAccountStats_UsesTotalCost(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		cs, nil,
		1, 10, "claude-sonnet-4",
		accountStatsUsage{Tokens: tokens, RequestCount: 1}, 0.75, "priority", // 已完成用户计费，不再重复应用服务层级倍率
	)
	require.NotNil(t, result)
...
func TestResolveAccountStatsCost_ApplyPricingToAccountStats_ZeroTotalCost_ReturnsNil(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		cs, nil,
		1, 10, "claude-sonnet-4",
		accountStatsUsage{RequestCount: 1}, 0.0, "", // totalCost = 0
	)
	require.Nil(t, result)
}
...
func TestResolveAccountStatsCost_FallsBackToLiteLLM(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		cs, bs,
		1, 10, "claude-sonnet-4",
		accountStatsUsage{Tokens: tokens, RequestCount: 1}, 999.0, "", // totalCost ignored
	)
	require.NotNil(t, result)
	// 100*0.001 + 50*0.002 = 0.1 + 0.1 = 0.2
	require.InDelta(t, 0.2, *result, 1e-12)
...
func TestResolveAccountStatsCost_Gemini36FlashTierUsesFallbackPricing(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		accountStatsUsage{Tokens: UsageTokens{InputTokens: 1_000_000, OutputTokens: 1_000_000, CacheReadTokens: 1_000_000}, RequestCount: 1}, 0, "",
	)
	require.NotNil(t, result)
...
func TestResolveAccountStatsCost_AllMiss_ReturnsNil(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		accountStatsUsage{Tokens: tokens, RequestCount: 1}, 0.0, "",
	)
	require.Nil(t, result)
}
...
func TestResolveAccountStatsCost_NilBillingService_SkipsLiteLLM(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		1, 10, "claude-sonnet-4",
		accountStatsUsage{Tokens: UsageTokens{InputTokens: 100}, RequestCount: 1}, 0.0, "",
	)
	require.Nil(t, result)
}
...
func TestResolveAccountStatsCost_CustomRulePriorityOverApplyPricing(t *testing.T) {
	...
	result := resolveAccountStatsCost(
		...
		cs, nil,
		1, 10, "claude-sonnet-4",
		accountStatsUsage{Tokens: tokens, RequestCount: 1}, 99.0, "", // totalCost = 99.0 (would be used if ApplyPricing wins)
	)
	require.NotNil(t, result)
...
func TestApplyAccountStatsCost_UsesUsageLogVideoFields(t *testing.T) {
	channel := &Channel{
		ID:     1,
		Status: StatusActive,
		AccountStatsPricingRules: []AccountStatsPricingRule{
	...
	applyAccountStatsCost(
		...
		1, 10, "", "sora-2", UsageTokens{}, 999,
	)

	require.NotNil(t, usageLog.AccountStatsCost)
	require.InDelta(t, 2.0, *usageLog.AccountStatsCost, 1e-12)
}
