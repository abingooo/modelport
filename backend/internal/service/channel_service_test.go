...
func TestMatchingPlatforms(t *testing.T) {
	tests := []struct {
		...
		{"composite returns concrete platforms", PlatformComposite, ConcretePlatforms},
	}
...
func TestValidatePricingEntries_RejectsUnsupportedBillingMode(t *testing.T) {
	...
	require.Error(t, err)
	require.Contains(t, err.Error(), "INVALID_BILLING_MODE")
}
