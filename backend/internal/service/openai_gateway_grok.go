...
func (s *OpenAIGatewayService) forwardGrokResponses(
	...
	if err := requireExplicitGrokSearchPriceForResponsesBody(c, patchedBody); err != nil {
		MarkResponseCommitted(c)
		writeOpenAIResponsesFallbackError(c, http.StatusNotFound, "not_found_error", err.Error())
		return nil, err
	}
