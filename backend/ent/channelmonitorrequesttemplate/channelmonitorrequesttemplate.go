...
func ProviderValidator(pr Provider) error {
	switch pr {
	case ProviderOpenai, ProviderAnthropic, ProviderGemini, ProviderGrok, ProviderAntigravity, ProviderKimi, ProviderZhipu, ProviderDeepseek, ProviderQwen, ProviderGlm, ProviderDoubao, ProviderMinimax, ProviderMimo:
		return nil
	default:
