...
describe('admin order currency display', () => {
  it('uses the ModelPort renminbi display symbol for paid and credited amounts', () => {
  ...
  it('uses the ModelPort renminbi display symbol for refundable balance amounts', () => {
