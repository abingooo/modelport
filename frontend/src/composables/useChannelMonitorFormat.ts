...
export function useChannelMonitorFormat() {
  ...
  function providerPickerClass(p: Provider | string, active: boolean): string {
    switch (p) {
      ...
      case PROVIDER_GLM:
        return active
          ? 'border-cyan-500 bg-cyan-50 text-cyan-700 dark:border-cyan-400 dark:bg-cyan-500/15 dark:text-cyan-300'
...
export function providerGradient(provider: string): string {
  switch (provider) {
    ...
    case PROVIDER_DOUBAO:
      return 'bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-500/10 dark:to-blue-500/20'
    case PROVIDER_MINIMAX:
      return 'bg-gradient-to-br from-rose-50 to-rose-100 dark:from-rose-500/10 dark:to-rose-500/20'
    case PROVIDER_MIMO:
      return 'bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-500/10 dark:to-orange-500/20'
    default:
