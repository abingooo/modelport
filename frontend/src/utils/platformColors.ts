...
const BADGE: Record<Platform, string> = {
  ...
  glm: 'bg-blue-500/10 text-blue-700 border-blue-500/30 dark:text-blue-300',
  kimi: 'bg-zinc-800/10 text-zinc-800 border-zinc-800/30 dark:bg-zinc-500/10 dark:text-zinc-200 dark:border-zinc-500/30',
  doubao: 'bg-blue-600/10 text-blue-800 border-blue-600/30 dark:text-blue-300',
  siliconflow: 'bg-purple-500/10 text-purple-700 border-purple-500/30 dark:text-purple-300',
  openrouter: 'bg-indigo-500/10 text-indigo-700 border-indigo-500/30 dark:text-indigo-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  glm: 'bg-blue-500/10 text-blue-700 dark:bg-blue-500/10 dark:text-blue-300',
  kimi: 'bg-zinc-800/10 text-zinc-800 dark:bg-zinc-500/10 dark:text-zinc-200',
  doubao: 'bg-blue-600/10 text-blue-800 dark:bg-blue-500/10 dark:text-blue-300',
  siliconflow: 'bg-purple-500/10 text-purple-700 dark:bg-purple-500/10 dark:text-purple-300',
  openrouter: 'bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300',
...
const BORDER: Record<Platform, string> = {
  ...
  glm: 'border-blue-500/20 dark:border-blue-500/20',
  kimi: 'border-zinc-800/20 dark:border-zinc-500/20',
  doubao: 'border-blue-600/20 dark:border-blue-500/20',
  siliconflow: 'border-purple-500/20 dark:border-purple-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  glm: 'bg-gradient-to-r from-blue-500 to-indigo-500',
  kimi: 'bg-gradient-to-r from-zinc-700 to-zinc-950',
  doubao: 'bg-gradient-to-r from-blue-600 to-blue-800',
  siliconflow: 'bg-gradient-to-r from-purple-500 to-violet-600',
  openrouter: 'bg-gradient-to-r from-indigo-500 to-violet-500',
...
const TEXT: Record<Platform, string> = {
  ...
  glm: 'text-blue-700 dark:text-blue-300',
  kimi: 'text-zinc-800 dark:text-zinc-200',
  doubao: 'text-blue-800 dark:text-blue-300',
  siliconflow: 'text-purple-700 dark:text-purple-300',
  openrouter: 'text-indigo-700 dark:text-indigo-300',
...
const ICON: Record<Platform, string> = {
  ...
  glm: 'text-blue-600 dark:text-blue-300',
  kimi: 'text-zinc-800 dark:text-zinc-200',
  doubao: 'text-blue-700 dark:text-blue-300',
  siliconflow: 'text-purple-600 dark:text-purple-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  glm: 'bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 dark:bg-blue-500 dark:hover:bg-blue-400',
  kimi: 'bg-zinc-800 text-white hover:bg-zinc-900 active:bg-black dark:bg-zinc-700 dark:hover:bg-zinc-600',
  doubao: 'bg-blue-700 text-white hover:bg-blue-800 active:bg-blue-900 dark:bg-blue-600 dark:hover:bg-blue-500',
  siliconflow: 'bg-purple-600 text-white hover:bg-purple-700 active:bg-purple-800 dark:bg-purple-500 dark:hover:bg-purple-400',
  openrouter: 'bg-indigo-600 text-white hover:bg-indigo-700 active:bg-indigo-800 dark:bg-indigo-500 dark:hover:bg-indigo-400',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  glm: 'bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300',
  kimi: 'bg-zinc-100 text-zinc-800 dark:bg-zinc-800 dark:text-zinc-200',
  doubao: 'bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300',
  siliconflow: 'bg-purple-100 text-purple-800 dark:bg-purple-900/40 dark:text-purple-300',
  openrouter: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  glm: 'from-blue-600 to-indigo-600',
  kimi: 'from-zinc-700 to-zinc-950',
  doubao: 'from-blue-600 to-blue-800',
  siliconflow: 'from-purple-600 to-violet-700',
  openrouter: 'from-indigo-600 to-violet-600',
...
const GRADIENT_TEXT: Record<Platform, string> = {
  ...
  glm: 'text-blue-100',
  kimi: 'text-zinc-100',
  doubao: 'text-blue-100',
  siliconflow: 'text-purple-100',
...
const GRADIENT_SUBTEXT: Record<Platform, string> = {
  ...
  glm: 'text-blue-200',
  kimi: 'text-zinc-300',
  doubao: 'text-blue-200',
  siliconflow: 'text-purple-200',
