export default {
  ...
  keys: {
    ...
    createKey: '创建密钥',
    selectKey: '选择密钥 {name}',
    bulkGroupAction: '修改分组（{count}）',
    bulkGroupTitle: '批量修改密钥分组',
    bulkGroupDescription: '将选中的 {count} 个 API 密钥统一分配到目标分组。',
    bulkGroupSuccess: '已更新 {count} 个 API 密钥的分组',
    bulkGroupFailed: '批量修改分组失败',
    editKey: '编辑密钥',
    deleteKey: '删除密钥',
    ...
    testModal: {
      title: '测试 API 密钥',
      noGroupTitle: '请先分配分组',
      noGroupDescription: '该密钥尚未绑定分组，无法确定可用模型和调度链路',
      modelLabel: '测试模型',
      reloadModels: '重新加载模型',
      searchModel: '搜索模型...',
      ...
      selectModel: '选择模型',
      invalidModelResponse: '模型列表响应格式无效',
      noModels: '该密钥当前没有可用模型',
      modelLoadFailed: '加载模型失败',
      promptLabel: '测试消息',
      promptPlaceholder: '输入要发送给模型的消息',
      defaultPrompt: '请只回复：连接成功',
      billingNotice: '测试请求将经过真实下游链路，并按照当前分组规则正常计费',
      ...
      reasoning: '思考过程',
      response: '模型响应',
      noTextResponse: '请求已成功完成，但模型没有返回文本内容',
      success: '下游链路测试成功',
      cancelled: '测试已停止',
      stop: '停止测试',
      start: '开始测试',
      retry: '重新测试',
      timeout: '请求超过 120 秒，测试已终止',
      failed: '下游链路测试失败',
      emptyResponse: '网关没有返回响应体'
    },
    useKeyModal: {
      title: '使用 API 密钥',
