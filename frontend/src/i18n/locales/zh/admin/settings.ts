export default {
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: '用户模型定价',
          description: '向已登录用户展示他们可访问分组中的模型基础价格。默认关闭。',
      ...
      site: {
        ...
        imageSiteUrl: '独立生图站地址',
        imageSiteUrlHint: '仅接受完整的 HTTP 或 HTTPS 地址；留空时生图站入口显示未配置状态。',
        imageSiteUrlPlaceholder: 'https://images.example.com',
        imageSiteUrlInvalid: '独立生图站地址必须是完整的 HTTP 或 HTTPS 地址',
        siteLogo: '站点Logo',
        uploadImage: '上传图片',
        remove: '移除',
