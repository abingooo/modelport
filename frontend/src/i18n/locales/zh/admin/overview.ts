export default {
    ...
    groups: {
      ...
      modelPricing: {
        ...
        add: '添加模型价格',
        modelsRequired: '第 {index} 条模型定价必须至少填写一个模型。',
        modelConflict: '模型模式“{model1}”与“{model2}”的匹配范围重叠，请删除其中一项或调整模式。',
        unitPriceRequired: '模型 {models} 必须设置默认价格或至少一个计费层级。',
