export default {
    ...
    riskControl: {
      ...
      viewCyberEvidence: '查看完整下游 JSON',
      cyberEvidenceContent: '完整下游 JSON',
      cyberEvidenceUnavailable: '原始 JSON 不可用',
      cyberEvidenceUnavailableHint: '该记录没有可查看的下游原始 JSON，可能来自升级前的历史数据或证据保存失败。',
      loadingCyberEvidence: '正在解密原始 JSON...',
      cyberEvidenceLoadFailed: '加载原始 JSON 失败',
      cyberEvidenceBytes: '正文大小',
      copyCyberEvidence: '复制完整 JSON',
      copyCyberEvidenceHash: '复制 SHA-256',
