export default {
  ...
  version: {
    currentVersion: '当前版本',
    modelPortVersion: 'ModelPort 版本',
    basedOnUpstream: '基于 {name} v{version}',
    latestVersion: '最新版本',
    upToDate: '已是最新版本',
    ...
    manualModeHint: '当前部署未启用在线更新，请使用经过校验的 ModelPort 发布资产',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateQueued: '更新请求已提交',
    containerRecreating: '宿主机正在校验发布摘要并重建容器',
    updateFailed: '更新失败',
    ...
    rollbackManualHint: '当前部署未启用在线回退，请按发布元数据使用固定摘要镜像',
    rollbackDockerWarning: '回退请求将由宿主机校验所选版本摘要后重建容器；数据库迁移不会自动回退',
    deployScript: '脚本部署',
    deployDocker: 'Docker',
