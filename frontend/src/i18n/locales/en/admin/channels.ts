export default {
    ...
    channels: {
      ...
      form: {
		...
		priceFieldCount: '{count} prices',
		tierCount: '{count} specifications',
		noPrice: 'No price',
    ...
    riskControl: {
      ...
      viewCyberEvidence: 'View Full Downstream JSON',
      cyberEvidenceContent: 'Full Downstream JSON',
      cyberEvidenceUnavailable: 'Original JSON Unavailable',
      cyberEvidenceUnavailableHint: 'No downstream JSON is available for this record. It may predate this release or evidence storage may have failed.',
      loadingCyberEvidence: 'Decrypting original JSON...',
      cyberEvidenceLoadFailed: 'Failed to load original JSON',
      cyberEvidenceBytes: 'Body size',
      copyCyberEvidence: 'Copy Full JSON',
      copyCyberEvidenceHash: 'Copy SHA-256',
