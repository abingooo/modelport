export default {
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: 'User Model Pricing',
          description: 'Show logged-in users base model prices for the groups they can access. Disabled by default.',
          configureLink: 'Configure model pricing in Channel Management > Channel Pricing',
          enabled: 'Enable User Model Pricing',
      ...
      site: {
        ...
        imageSiteUrl: 'External image studio URL',
        imageSiteUrlHint: 'Only absolute HTTP or HTTPS URLs are accepted. Leave empty to show an unconfigured state.',
        imageSiteUrlPlaceholder: 'https://images.example.com',
        imageSiteUrlInvalid: 'The image studio URL must be an absolute HTTP or HTTPS URL',
        siteLogo: 'Site Logo',
