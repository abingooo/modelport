export default {
  ...
  keys: {
    ...
    selectKey: 'Select API key {name}',
    bulkGroupAction: 'Change group ({count})',
    bulkGroupTitle: 'Change API Key Groups',
    bulkGroupDescription: 'Assign the {count} selected API keys to one group.',
    bulkGroupSuccess: 'Updated the group for {count} API keys',
    bulkGroupFailed: 'Failed to change API key groups',
    ...
    testModal: {
      title: 'Test API Key',
      noGroupTitle: 'Assign a group first',
      noGroupDescription: 'This key has no group, so its models and routing path cannot be determined.',
      ...
      invalidModelResponse: 'The model list response is invalid',
      noModels: 'No models are currently available to this key',
      modelLoadFailed: 'Failed to load models',
      promptLabel: 'Test Message',
      promptPlaceholder: 'Enter a message to send to the model',
      defaultPrompt: 'Reply with exactly: Connection successful',
      billingNotice: 'The test uses the real downstream path and is billed under the current group rules.',
      firstTokenLatency: 'First Token',
      totalLatency: 'Total Time',
      ready: 'Select a model and start the test',
      running: 'Waiting for the model response...',
      reasoning: 'Reasoning',
      response: 'Model Response',
      noTextResponse: 'The request completed successfully without text output',
      success: 'Downstream path test succeeded',
      cancelled: 'Test stopped',
      stop: 'Stop Test',
      start: 'Start Test',
      retry: 'Test Again',
      timeout: 'The request exceeded 120 seconds and was stopped',
      failed: 'Downstream path test failed',
      emptyResponse: 'The gateway returned no response body'
    },
    useKeyModal: {
      title: 'Use API Key',
      description:
