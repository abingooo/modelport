...
import { DEFAULT_SITE_NAME, MODELPORT_BRAND, isModelPortSiteName } from '@/utils/branding'
...
export function resolveRouteDocumentTitle(
  ...
  if (route.name === 'Home' && isModelPortSiteName(siteName)) {
    return MODELPORT_BRAND.homeTitle
  }
